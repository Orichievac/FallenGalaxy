...
public class StolenResourcesEvent extends GameEvent {
	// ------------------------------------------------------- CONSTANTES -- //
	// -------------------------------------------------------- ATTRIBUTS -- //
	...
	private long[] stolenResources;

	// ---------------------------------------------------- CONSTRUCTEURS -- //
	
	public StolenResourcesEvent(Fleet source, Fleet target,
			long[] stolenResources) {
		super();
		this.source = source;
		this.target = target;
	...
	public long[] getStolenResources() {
