...
public class RetreatEvent extends GameEvent {
	// ------------------------------------------------------- CONSTANTES -- //
	// -------------------------------------------------------- ATTRIBUTS -- //
	...
	private int retreatRound;

	// ---------------------------------------------------- CONSTRUCTEURS -- //

	public RetreatEvent(Fleet attackingFleet, Fleet defendingFleet,
			int retreatRound) {
		super();
		this.attackingFleet = attackingFleet;
		this.defendingFleet = defendingFleet;
		this.retreatRound = retreatRound;
	}
