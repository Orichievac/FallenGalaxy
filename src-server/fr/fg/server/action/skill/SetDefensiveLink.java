...
public class SetDefensiveLink extends Action {
	...
	protected String execute(Player player, Map<String, Object> params,
		...
		if (fleet.getSkillLevel(Skill.SKILL_DEFENSIVE_LINK) < 0)
			throw new IllegalOperationException(
					"La flotte n'a pas la compétence lien défensif.");
		...
		Fleet linkedFleet = fleet.getDefensiveLinkedFleet();
		...
		// Crée le lien défensif
		FleetLink link = new FleetLink(fleet.getId(),
				target.getId(), FleetLink.LINK_DEFENSIVE);
		link.save();
