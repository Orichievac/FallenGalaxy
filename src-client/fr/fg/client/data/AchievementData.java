...
public class AchievementData extends JavaScriptObject {
	// ------------------------------------------------------- CONSTANTES -- //
	...
	public native final int getType() /*-{
		return this[@fr.fg.client.data.AchievementData::FIELD_TYPE];
	}-*/;
	
	public native final double getScore() /*-{
		return this[@fr.fg.client.data.AchievementData::FIELD_SCORE];
	}-*/;
