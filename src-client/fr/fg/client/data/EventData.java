...
public class EventData extends JavaScriptObject {
	...
	public final static int
		...
		EVENT_FLEET_ATTACK 			= 10, // P (nom flotte attaquante, nom flotte attaquée, nom joueur attaqué, nom secteur coords secteur)
		EVENT_FLEET_UNDER_ATTACK 	= 11, // P (nom flotte attaquée, nom flotte attaquante, nom joueur attaquant, nom secteur coords secteur)
		...
		EVENT_STATION_UNDER_ATTACK	= 15, // P (nom station, pourcentage de PV restants)
		EVENT_STATION_LOST			= 16, // P (nom station)
		EVENT_STATION_SELF_DESTRUCT	= 17, // P (nom station, nom joueur)
		EVENT_SWAP					= 18, // P (nom station, nom joueur)
		EVENT_EMP					= 19, // P (nom flotte échangée, nom flotte source, nom joueur source)
	...
	public native final int getType() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_TYPE];
	}-*/;

	public native final String getArg1() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_ARG1];
	}-*/;

	public native final String getArg2() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_ARG2];
	}-*/;

	public native final String getArg3() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_ARG3];
	}-*/;

	public native final String getArg4() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_ARG4];
	}-*/;

	public native final double getDate() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_DATE];
	}-*/;

	public native final int getIdArea() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_ID_AREA];
	}-*/;

	public native final int getX() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_X];
	}-*/;

	public native final int getY() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_Y];
	}-*/;

	public native final String getAreaName() /*-{
		return this[@fr.fg.client.data.EventData::FIELD_AREA_NAME];
	}-*/;
