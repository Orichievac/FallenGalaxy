...
public class HyperspaceSignatureMiniItem extends AnimatedMiniItem {
	// ------------------------------------------------------- CONSTANTES -- //
	// -------------------------------------------------------- ATTRIBUTS -- //
	// ---------------------------------------------------- CONSTRUCTEURS -- //

	public HyperspaceSignatureMiniItem(
			HyperspaceSignatureData hyperspaceSignatureData,
			UIMiniItemRenderingHints hints) {
		super(hyperspaceSignatureData.getX(), hyperspaceSignatureData.getY(), hints);
